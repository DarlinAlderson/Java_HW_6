public class NotebookCatalogue {
    ...
    public NotebookCatalogue(int id, int hdd_volume, int ram_volume, int display_size, String os_type, String color,
            String brand) {
        this.id = id;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        NotebookCatalogue other = (NotebookCatalogue) obj;
        if (brand == null) {
            if (other.brand != null)
                return false;
